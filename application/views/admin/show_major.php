...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
	<div class="row">
            <h2><center>Major Table</center></h2>
            <div  align= right  id="custom-search-input">
                <div class="input-group col-md-3">
                              <input type="text" class="  search-query form-control" placeholder="Search" />
                                 <span class="input-group-btn">
                                    <bih<button class="btn btn-danger" type="button">
     ...
     <div class="col col-xs-6 text-right">
                     <a href="<?php echo site_url('start/page_addmajor'); ?>"><p align = "left"><button type="button" class="btn btn-sm btn-primary btn-create">Create New</button></p>
                  </a></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th><center>รหัสสาขาวิชา</center></th>
                        ...
                        <tbody>
                            ...
                            <td><?php echo $value->fac_name; ?> </td>
                                <tr>
                                    <td><center><?php echo $value->major_id; ?> </center></td>
        ...
        <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
            ...
            <!-- /.modal-dialog --> 
             ...
             <div class="col col-xs-6 text-left">
                      ...
                      <a href="<?php echo site_url('start/page_home'); ?>"><p align = "right"><button type="button" class="btn btn-sm btn-primary btn-create">Back</button></p>
                  </a></div>
    </body>
